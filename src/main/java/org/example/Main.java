...
public class Main {
    public static void main(String[] args) {
        ...
        // ----------------------- CREAACION DE ARTIUCLOS Y NEGOCIO DE TRAZAA 2 ----------------------------------------
...
//        todosLosArticulosManufacturados.forEach(System.out::println);
        ...
        // ----------------------------- CREAACION DE SUCURSALES Y LOCALIDADES DE TRAAZA 1 -------------------------------------
...
//        }
        ...
        // ----------------------------- UNION DE TRAAZA 1 Y TRAAZAA 2, MOSTRAMOS RESULTADOS

        sucursal1.agregarArticulo(pizzaHawaina);
        sucursal1.mostrarArticulos();
